                                             ...
                                             GLint     border)
{
    ...
    // playbook
    OSG_NOTICE << "Info: generateTextureObject(target,numMipMapLevels,internalFormat,width,height,depth)" << std::endl;
    OSG_NOTICE << "Info: -> " << target << "," << numMipmapLevels << "," << internalFormat << "," << width << "," << height << "," << depth << std::endl;
